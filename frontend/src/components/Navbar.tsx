        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              <img src="/lovable-uploads/7d120ee6-3614-4b75-9c35-716d54490d67.png" alt="Revv Aerospace Logo" className={cn("h-8 w-auto", isScrolled ? "" : "brightness-0 invert")} />
              <span
  className={cn(
                    ...
                    <ul className="grid gap-3 p-4 w-[400px]">
                      <li>
                        <Link to="/projects/firecat" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Tactical Defense Drones</div>
                          <p className="text-sm text-gray-500">Military-grade autonomous systems</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/projects/sport-retail" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Commercial Delivery</div>
                          <p className="text-sm text-gray-500">Last-mile logistics solutions</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/projects/workwear" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Search & Rescue</div>
                          <p className="text-sm text-gray-500">Emergency response systems</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/projects/hockey" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Surveillance Platform</div>
                          <p className="text-sm text-gray-500">Advanced monitoring systems</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/projects/pet-tracker" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Agricultural Drones</div>
                          <p className="text-sm text-gray-500">Precision farming technology</p>
                        </Link>
                      </li>
                    </ul>
                  </NavigationMenuContent>
                    ...
                    <ul className="grid gap-3 p-4 w-[400px]">
                      <li>
                        <Link to="/tech-details" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          <div className="font-medium">Drone Technology</div>
                          <p className="text-sm text-gray-500">How our autonomous flight systems work</p>
                        </Link>
                      </li>
                      <li>
                        <Link to="/development-process" className="block p-3 space-y-1 rounded-md hover:bg-gray-100">
                          ...
                          <p className="text-sm text-gray-500">Our approach to creating cutting-edge UAVs</p>
                        </Link>
                      </li>
                      <li>
