...
import droneHeroImage from "@/assets/drone-hero-background.jpg";
        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>India’s Indigenous Defense Drone Manufacturer.</motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
              Designing the Future of Tactical UAVs for National Security
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Who We Are</h3>
            <p className="text-gray-600 text-xs md:text-sm">Deep-tech drone manufacturing company ,Driven by R&D, AI, and full-stack UAV integration
</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Mission And Vision</h3>
            <p className="text-gray-600 text-xs md:text-sm">Build mission-ready, autonomous drones for national security, environmental monitoring, and aerospace advancement And To empower India through completely indigenous UAV innovation   </p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Multi-Mission</h3>
            <p className="text-gray-600 text-xs md:text-sm">Build mission-ready, autonomous drones for national security, environmental monitoring, and aerospace advancement</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
