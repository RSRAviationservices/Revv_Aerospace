      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <img 
              ...
              alt="Revv Aerospace Logo" 
              className="h-15 w-auto mb-6 invert" // Added invert to make logo white
            />
            <h1 className="text-gray-300 mb-20 text-2xl font-bold">Revv Aerospace</h1>
            <p className="text-gray-300 mb-6">
              Revv Aerospace provides cutting-edge autonomous drone systems for commercial and defense applications, delivering mission-critical capabilities with advanced AI technology and precision engineering.
            </p>
            <p>
             info@revvaerospace.in
            </p>
            <p className="text-gray-300 mb-6">
             67-68 platinum spring <br />
              Taloja, Navi Mumbai, Maharashtra, India
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/company/revvaerospace/" 
                target="_blank" 
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Revv Aerospace. All rights reserved.
          </p>
