...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Advanced AI-powered flight systems that enable fully autonomous missions with precision waypoint navigation and obstacle avoidance.",
      image: "/lovable-uploads/48e540e5-6a25-44e4-b3f7-80f3bfc2777a.png"
    },
    {
      icon: <Shield className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Defense & Security",
      description: "Military-grade surveillance and reconnaissance platforms designed for tactical missions and border security operations.",
      image: "/lovable-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png"
    },
    {
      icon: <HardHat className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Search & Rescue",
      description: "Emergency response drones equipped with thermal imaging, communications relay, and payload delivery capabilities.",
      image: "/lovable-uploads/cf8966e3-de0d-445f-9fbd-ee6c48daa7ff.png"
    },
    {
      icon: <Zap className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Commercial Delivery",
      description: "High-efficiency logistics drones for last-mile delivery, medical supply transport, and industrial applications.",
  ...
  const sensorCaseStudies = [{
    ...
    description: "Advanced reconnaissance drones with multi-spectrum imaging, secure communications, and long-range capabilities."
  }, {
    image: "/lovable-uploads/5463c9c5-0946-4280-a14b-17636ff69a98.png",
    title: "Emergency Response",
    description: "Search and rescue platforms with thermal sensors, GPS tracking, and emergency supply delivery systems."
  }, {
    image: "/lovable-uploads/c5f8ee24-9815-4ebe-b65d-6f3d449feb8b.png",
    title: "Commercial Logistics",
    description: "Autonomous delivery drones with precision landing, payload management, and real-time tracking capabilities."
  }];
  const stepFlowItems = [{
    icon: <Microchip className="h-10 w-10 text-gray-700" />,
    title: "Revv Aerospace Proprietary Systems",
    description: "Our advanced flight control and AI navigation modules"
  }, {
    icon: <Factory className="h-10 w-10 text-gray-700" />,
    title: "Military-Grade Components",
    description: "Precision-engineered hardware for mission-critical applications"
  }, {
    icon: <Handshake className="h-10 w-10 text-gray-700" />,
    title: "Aerospace Manufacturing Partners",
    description: "Certified production facilities for quality and reliability"
  }];
  const sprintPhases = [{
    name: "Planning",
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Our advanced drone systems integrate cutting-edge AI, precision engineering, and autonomous capabilities to deliver mission-critical performance across diverse operational environments.
            </p>
          </div>
          ...
          {/* <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              <div className="inline-block mb-2 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium">
                Drone System Applications
              </div>
              <h3 className="text-2xl font-bold">Mission-Critical Platforms</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Explore how our autonomous drone systems are deployed across military, commercial, and emergency response operations.
            ...
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              ...
              <div className="text-center mt-6 text-sm text-gray-600">
                <p className="text-sm text-gray-600 mt-2 text-center font-medium">These platforms showcase our advanced autonomous capabilities across multiple mission types</p>
              </div>
            </div>
          </div> */}
        </div>
      ...
      <section id="technology" className="bg-gray-50 py-10 md:py-16">
        {/* <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">How our drone systems work</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Revv Aerospace develops autonomous drone platforms using proprietary flight control systems and carefully selected aerospace-grade components, 
              enabling us to create mission-specific solutions with unmatched reliability and performance.
            </p>
          </div>
