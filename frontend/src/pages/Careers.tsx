            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <motion.div 
                  ...
                  className="mb-16"
                >
                  <h2 className="text-3xl font-bold mb-6">Why Join Revv Aerospace?</h2>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mt-12">
                    <h3 className="font-bold text-xl mb-6">Contact Our Team</h3>
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      <div className="flex flex-col items-center text-center">
                        ...
                        />
                        <h3 className="text-xl font-bold text-gray-900">Risabh Yadav</h3>
